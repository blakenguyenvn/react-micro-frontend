...
export const getContacts = createAsyncThunk(
	...
	async (routeParams, { getState }) => {
		routeParams =
			routeParams || getState().contactsApp.contacts.routeParams;
		const response = await API.get('/api/contacts-app/contacts', {
			params: routeParams
		});
...
export const addContact = createAsyncThunk(
	...
	async (contact, { dispatch, getState }) => {
		const response = await API.post('/api/contacts-app/add-contact', {
			contact
		});
		const data = await response.data;
...
export const updateContact = createAsyncThunk(
	...
	async (contact, { dispatch, getState }) => {
		const response = await API.post('/api/contacts-app/update-contact', {
			contact
		});
		const data = await response.data;
...
export const removeContact = createAsyncThunk(
	...
	async (contactId, { dispatch, getState }) => {
		await API.post('/api/contacts-app/remove-contact', { contactId });
...
export const removeContacts = createAsyncThunk(
	...
	async (contactIds, { dispatch, getState }) => {
		await API.post('/api/contacts-app/remove-contacts', { contactIds });
