				...
				<div className="p-12 md:p-24 max-w-2xl">
					<div>
						...
						<Typography className="mb-16" component="p">
							Vin React developed based on Material-UI as ui
							library.
							<a
								className="mx-4"
							...
							uses JSS at its core. Therefore the Vin React
							supports
							<a
								className="mx-4"
					...
					<div>
						...
						<Typography className="mb-16" component="p">
							...
							<b>helper classes</b> for fast development, ease of
							use, globally access etc. So we have used both in
							components.
						</Typography>
						...
						<Typography className="mb-16" component="p">
							...
							as an engine for generating helper classes. It's not
							an UI kit and it's customizable. You can find the
							config file of Tailwind with named "
							<b>tailwind.js</b>" under the root of Vin React.
						</Typography>
					</div>
				</div>
			}
