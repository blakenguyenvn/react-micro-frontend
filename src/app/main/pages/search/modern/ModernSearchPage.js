				...
				<div className="p-16 pt-0 sm:p-24 sm:pt-0 max-w-md">
							...
							{data.map(_item => (
								...
								>
									<Typography
										className={clsx(
											classes.title,
											'text-18 font-medium cursor-pointer'
										)}
									>
										{_item.title}
									</Typography>
									<Typography
										className={clsx(classes.url, 'my-4')}
									>
										{_item.url}
									</Typography>
					...
					<div className="flex justify-center mt-48">
						<Paper className="rounded-16 shadow">
							...
							<Button className="min-w-48 h-48 p-0 px-16">
								1
							</Button>
							<Button className="min-w-48 h-48 p-0 px-16">
								2
