import VinCountdown from '@vincore/core/VinCountdown';
					...
					<Card className="w-full max-w-384">
						<CardContent className="flex flex-col items-center justify-center p-16 sm:p-32 text-center">
							<img
								...
								src="assets/images/logos/Vin.svg"
								alt="logo"
							/>
							...
							<Typography
								...
								className="max-w-288"
							>
								It’s not quite ready yet, but we are working
								hard and it will be ready in approximately:
							</Typography>
							...
							<Typography className="font-semibold my-32 w-full">
								If you would like to be notified when the app is
								ready, you can subscribe to our e-mail list.
							</Typography>
