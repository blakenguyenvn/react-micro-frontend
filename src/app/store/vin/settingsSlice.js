...
const getThemes = state => state.vin.settings.themes;
const getDirection = state => state.vin.settings.current.direction;
const getMainThemeId = state => state.vin.settings.current.theme.main;
const getNavbarThemeId = state => state.vin.settings.current.theme.navbar;
const getToolbarThemeId = state => state.vin.settings.current.theme.toolbar;
const getFooterThemeId = state => state.vin.settings.current.theme.footer;
