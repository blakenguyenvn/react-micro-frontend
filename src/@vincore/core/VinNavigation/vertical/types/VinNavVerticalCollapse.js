...
function VinNavVerticalCollapse(props) {
		...
		() => (
			<ul className={clsx(classes.root, open && 'open')}>
				...
				>
					...
					{item.badge && (
						<VinNavBadge className="mx-4" badge={item.badge} />
					)}
...
VinNavVerticalCollapse.propTypes = {
...
VinNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = VinNavVerticalCollapse;
