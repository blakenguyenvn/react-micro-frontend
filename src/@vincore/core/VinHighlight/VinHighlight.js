...
function VinHighlight(props) {
	...
	function trimCode() {
		...
		// can be formatted properly while using vin-highlight
		// component
...
VinHighlight.propTypes = {
	component: PropTypes.node
};
VinHighlight.defaultProps = {
	component: 'code'
};

export default memo(VinHighlight);
