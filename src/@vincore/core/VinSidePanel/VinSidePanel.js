		...
		<>
			<Hidden mdDown>
				<Paper
					...
					square
				>
					<VinScrollbars className={clsx('content', classes.content)}>
						{props.children}
					</VinScrollbars>
					...
					<div className={classes.buttonWrapper}>
						<Tooltip
							...
							placement={
								props.position === 'left' ? 'right' : 'right'
							}
						>
							<IconButton
...
VinSidePanel.propTypes = {};
VinSidePanel.defaultProps = {
	position: 'left',
	opened: true
};

export default memo(VinSidePanel);
