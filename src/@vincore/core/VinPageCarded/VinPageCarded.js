...
import VinPageCardedHeader from './VinPageCardedHeader';
import VinPageCardedSidebar from './VinPageCardedSidebar';
...
const VinPageCarded = forwardRef((props, ref) => {
...
VinPageCarded.defaultProps = {};

export default memo(VinPageCarded);
