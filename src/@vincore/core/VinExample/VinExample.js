import VinHighlight from '@vincore/core/VinHighlight';
	...
	return (
		<Card className={clsx(className, 'shadow')}>
			...
			<div className="flex justify-center max-w-full">
				<div
					className={
						currentTab === 0 ? 'flex flex-1 max-w-full' : 'hidden'
					}
				>
					{Component &&
						(iframe ? (
...
VinExample.propTypes = propTypes;
VinExample.defaultProps = defaultProps;

export default VinExample;
